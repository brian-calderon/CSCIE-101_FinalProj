...
\par The odds of survival increases by 38.16% when the passenger is second class. ((exp(0.32326) - 1) * 100)
\par The odds of survival decreases by 68.37% when the passenger is male. ((exp(-1.15125) - 1) * 100)
\par The odds of survival decreases by 63.19% when the passenger is from deck G. ((exp(-0.99963) - 1) * 100)

\par Our Poisson Regression has an accuracy of 75.51% with optimal cutoﬀ(.17) based on max F1 score (0.7272).
